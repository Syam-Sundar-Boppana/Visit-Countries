...
import CountryItem from './Component/CountryItem/index'
import VisitedCountries from './Component/VisitedCountries/index'
import './App.css'
...
class App extends Component {
  ...
  onclickVisit = id => {
    ...
    const updateData = countriesList.map(item => {
      if (item.id === id) {
